...
<head>
    ...
    <style>
        ...
        /* INFO CARD */
        .info-card { border: none; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.06); background: white; }
        .info-item { display: flex; align-items: center; padding: 12px 0; border-bottom: 1px solid #f0f0f0; }
        .info-item:last-child { border-bottom: none; }
        .info-icon { width: 40px; height: 40px; background: #e8f0fe; color: var(--primary); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px; font-size: 1.1rem; }
        
        /* TIMELINE STOPS */
        .timeline-stops { position: relative; padding-left: 30px; margin-left: 15px; }
        .timeline-stops::before { content: ''; position: absolute; left: 5px; top: 10px; bottom: 10px; width: 3px; background: #e0e0e0; }
        .timeline-item { position: relative; padding-bottom: 25px; }
        .timeline-item:last-child { padding-bottom: 0; }
        .timeline-marker { position: absolute; left: -30px; top: 4px; width: 14px; height: 14px; border-radius: 50%; background: white; border: 3px solid var(--primary); z-index: 2; transition: all 0.2s; }
        .timeline-item:first-child .timeline-marker { border-color: #2e7d32; background: #e8f5e9; }
        .timeline-item:last-child .timeline-marker { border-color: #d32f2f; background: #ffebee; }
        .timeline-item:hover .timeline-marker { transform: scale(1.2); background: var(--accent); }
        .stop-index { color: #888; font-weight: 600; font-size: 0.9rem; margin-right: 8px; }
        .stop-name { font-weight: 600; color: #1a1a2e; font-size: 1.05rem; }
    </style>
</head>
<body>
...
<c:choose>
        ...
        <div class="detail-header">
            <div class="container text-center text-md-start">
                <div class="row align-items-center g-3">
                    ...
                    <div class="col-md">
                        <h2 class="fw-bold m-0">${route.routeName}</h2>
    ...
    <c:otherwise>
        <div class="container my-5 py-5 text-center">
            <div class="card info-card p-5 max-width-600 mx-auto">
