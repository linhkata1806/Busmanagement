            ...
            <div class="ticket-container">
                ...
                <div class="card ticket-card shadow-sm">
                    ...
                    <div class="ticket-body">
                        ...
                        <form action="${pageContext.request.contextPath}/customer/buy-ticket" method="POST" class="mt-4 needs-validation">                            <input type="hidden" name="routeId" value="${route.routeID != null ? route.routeID : 0}">
