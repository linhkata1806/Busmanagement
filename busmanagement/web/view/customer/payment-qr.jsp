                    ...
                    <div class="card payment-card">
                        ...
                        <div class="card-body p-4 text-center">
                            ...
                            <div class="qr-wrapper">
                                ...
                                <c:set var="qrData" value="Chuyen khoan Bus Ha Noi: Loai ve ${requestScope.qrType}, So tien ${requestScope.qrAmount}đ, Tuyen ${requestScope.qrRoute}"/>                                 src="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=${qrData}" 
