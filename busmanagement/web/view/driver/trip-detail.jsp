                            ...
                            <div class="card shadow-sm border-0 rounded-3 mb-4">
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex flex-column gap-3">
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <span class="badge bg-danger px-2.5 py-1.5 rounded">${trip.status}</span>
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
                                        </div>
                                        ...
                                        <!-- Start / Finish Trip Action Buttons -->
                                        <c:if test="${trip.status == 'SCHEDULED' || trip.status == 'IN_PROGRESS'}">
