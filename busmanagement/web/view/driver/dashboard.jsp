                                                ...
                                                <div class="d-flex flex-column gap-2">
                                                    <c:choose>
                                                        <c:when test="${currentTrip.status == 'SCHEDULED'}">
                                                            <form action="trip/start" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn BẮT ĐẦU chuyến đi này?');">
                                                        ...
                                                        <c:when test="${currentTrip.status == 'IN_PROGRESS'}">
                                                            <form action="trip/finish" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn KẾT THÚC chuyến đi này?');">
                                                                <input type="hidden" name="tripID" value="${currentTrip.tripID}">
