...
<nav class="col-md-3 col-lg-2 d-md-block bus-sidebar collapse p-3 shadow position-relative">
    ...
    <div class="desktop-brand d-flex align-items-center mb-4 px-2">
        <i class="fas fa-bus-alt fa-2x text-warning me-2"></i>
        <span class="fs-5 fw-bold text-white">Tài Xế Bus</span>
    </div>
    ...
    <div class="mobile-nav-container w-100 d-md-none">
        <div class="dropdown">
                ...
                <span class="fw-semibold text-white">
                    <c:choose>
                        ...
                        <c:when test="${param.activeMenu == 'trip'}">
                            <i class="fas fa-route text-warning me-2"></i>Chuyến đi của tôi
                        </c:when>
                        ...
                        <c:when test="${param.activeMenu == 'profile'}">
                            <i class="fas fa-user-circle text-warning me-2"></i>Thông tin cá nhân
                        </c:when>
                        <c:otherwise>
                            <i class="fas fa-bus-alt text-warning me-2"></i>Tài Xế Bus
                        </c:otherwise>
                    </c:choose>
                </span>
            </button>
            <ul class="dropdown-menu dropdown-menu-dark w-100 shadow border-0 mt-2" aria-labelledby="mobileMenuDropdown" style="background-color: #0d47a1; border: 1px solid rgba(255,255,255,0.15); border-radius: 0.5rem; padding: 0.5rem;">
                <li>
                    <a class="dropdown-item py-2 px-3 rounded-2 ${param.activeMenu == 'dashboard' ? 'active' : ''}" href="${pageContext.request.contextPath}/driver/dashboard">
                        <i class="fas fa-chart-pie me-2"></i>Tổng quan
                    </a>
                </li>
                <li>
                    <a class="dropdown-item py-2 px-3 rounded-2 ${param.activeMenu == 'trip' ? 'active' : ''}" href="${pageContext.request.contextPath}/driver/trip">
                        <i class="fas fa-route me-2"></i>Chuyến đi của tôi
                    </a>
                </li>
                <li>
                    <a class="dropdown-item py-2 px-3 rounded-2 ${param.activeMenu == 'notification' ? 'active' : ''}" href="${pageContext.request.contextPath}/driver/notification">
                ...
                <li>
                    <a class="dropdown-item py-2 px-3 rounded-2 ${param.activeMenu == 'profile' ? 'active' : ''}" href="${pageContext.request.contextPath}/driver/profile">
    ...
    <ul class="nav flex-column gap-2 mb-5">
        <li class="nav-item">
            <a class="nav-link py-2.5 px-3 ${param.activeMenu == 'dashboard' ? 'active' : ''}" href="${pageContext.request.contextPath}/driver/dashboard">
                <i class="fas fa-chart-pie me-2"></i>Tổng quan
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link py-2.5 px-3 ${param.activeMenu == 'trip' ? 'active' : ''}" href="${pageContext.request.contextPath}/driver/trip">
                <i class="fas fa-route me-2"></i>Chuyến đi của tôi
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link py-2.5 px-3 ${param.activeMenu == 'notification' ? 'active' : ''}" href="${pageContext.request.contextPath}/driver/notification">
                <i class="fas fa-bell me-2"></i>Thông báo
                <c:if test="${not empty unreadCount and unreadCount > 0}">
        ...
        <li class="nav-item">
            <a class="nav-link py-2.5 px-3 ${param.activeMenu == 'profile' ? 'active' : ''}" href="${pageContext.request.contextPath}/driver/profile">
                <i class="fas fa-user-circle me-2"></i>Thông tin cá nhân
            </a>
        </li>
    </ul>
