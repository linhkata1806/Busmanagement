            ...
            <div class="row">
                <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse p-3 shadow">
                    ...
                    <ul class="nav flex-column gap-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link py-2.5 px-3" href="#">
                        ...
                        <div class="col-md-4">
                            <div class="card h-100 shadow-sm stat-card bg-white">
                                <div class="card-body p-4">
                                    ...
                                    <div class="pt-2">
                                        <a href="${pageContext.request.contextPath}/staff/monthly-pass?status=PENDING" class="small text-decoration-none fw-bold text-warning">
                                            Xử lý hồ sơ ngay <i class="fas fa-arrow-right ms-1"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card h-100 shadow-sm stat-card bg-white">
                                <div class="card-body p-4">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <div>
                                            <p class="text-uppercase fs-7 fw-bold text-muted mb-1">Chuyến xe trong ngày</p>
                                    ...
                                    <div class="pt-2">
                                        <a href="#" class="small text-decoration-none fw-bold text-success">
                                            Xem lịch trình <i class="fas fa-arrow-right ms-1"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="pt-2">
                                        <a href="#" class="small text-decoration-none fw-bold text-primary">
                                            Xem lịch sử gửi <i class="fas fa-arrow-right ms-1"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 bg-white">
                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <a href="#" class="btn btn-light w-100 py-3 text-start px-4 shadow-2xs rounded-3 quick-action-btn text-dark fw-semibold">
                                        <i class="fas fa-calendar-plus text-success me-3 fa-lg"></i>Thêm lịch trình chuyến
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <a href="#" class="btn btn-light w-100 py-3 text-start px-4 shadow-2xs rounded-3 quick-action-btn text-dark fw-semibold">
