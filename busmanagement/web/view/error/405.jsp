...
<head>
    <meta charset="UTF-8">
    <title>Phương thức không được phép - Hanoi Bus</title>
...
<body>
    ...
    <div class="main-content container my-5">
        <div class="card shadow-sm p-5 border-0 text-center" style="max-width: 500px; width: 100%; border-radius: 12px; background: #ffffff;">
            <div class="mb-4">
                <h1 class="fw-bold" style="font-size: 6rem; color: #dc3545; margin-bottom: 0;">405</h1>
            </div>
            <h2 class="fw-bold text-dark mb-3">Phương Thức Không Hợp Lệ</h2>
            <p class="text-muted mb-4">
                Yêu cầu của bạn không thể được xử lý (Method Not Allowed). Vui lòng kiểm tra lại phương thức gửi dữ liệu.
            </p>
            <div class="mb-3">
