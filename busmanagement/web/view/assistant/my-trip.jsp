...
<head>
    ...
    <title>Chuyến đi của tôi - Phụ xe</title>
                            ...
                            <table class="table table-hover table-striped align-middle mb-0">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th scope="col">Dự kiến kết thúc</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center pe-4">
                                                        <div class="d-inline-flex gap-2">
                                                            <c:if test="${t.status == 'IN_PROGRESS' || t.status == 'SCHEDULED'}">
                                                                <a href="passenger-check?tripID=${t.tripID}" class="btn btn-sm btn-primary">
                                                                    <i class="fas fa-qrcode me-1"></i>Soát vé
                                                                </a>
                                                            </c:if>
                                                            <a href="trip/detail?id=${t.tripID}" class="btn btn-sm btn-outline-secondary">
                                        ...
                                        <c:otherwise>
                                            <tr>
                                                <td colspan="9" class="text-center py-5 text-secondary">
                                                    Không có dữ liệu chuyến đi nào được phân công.
                                                </td>
                                            </tr>
                                        </c:otherwise>
                                    </c:choose>
