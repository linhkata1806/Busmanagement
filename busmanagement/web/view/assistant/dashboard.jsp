...
<head>
    ...
    <title>Tổng Quan Vận Hành - Phụ Xe</title>
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-12 col-sm-6 col-xl-4">
                        <div class="stat-card p-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="text-secondary mb-1">Đã soát vé</h6>
                                    <h4 class="fw-bold mb-0 text-dark">${totalChecked} lượt</h4>
                                </div>
                    ...
                    <div class="col-12 col-sm-6 col-xl-4">
                        <div class="stat-card p-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="text-secondary mb-1">Hành khách chờ soát</h6>
                                    <h4 class="fw-bold mb-0 text-dark">${passengersRemaining} lượt</h4>
                                </div>
                                <div class="stat-icon bg-card-orange">
                                    <i class="fas fa-user-clock"></i>
                                </div>
                            </div>
                            <div class="mt-2 text-warning fs-7">
                                Số vé chưa kích hoạt trên tuyến
                            </div>
                        </div>
                    </div>
                </div>

                <!-- Current Trip Management Panel -->
                <div class="row">
                    <div class="col-12">
                                ...
                                <c:choose>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-8">
                                                <div class="d-flex flex-column gap-2 mb-3 mb-md-0">
                                                    ...
                                                    <div><strong>Tài xế phụ trách:</strong> ${currentTrip.driverName}</div>
                                            ...
                                            <div class="col-md-4 text-md-end">
                                                <div class="d-flex flex-column gap-2">
                                                    <a href="passenger-check?tripID=${currentTrip.tripID}" class="btn btn-primary btn-lg shadow-sm">
                                                        <i class="fas fa-qrcode me-2"></i>Soát vé & Check-In
                                                    </a>
                                                    <a href="trip/detail?id=${currentTrip.tripID}" class="btn btn-outline-secondary">
                                                        <i class="fas fa-info-circle me-2"></i>Xem lộ trình chi tiết
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <c:otherwise>
                                        <div class="text-center py-5 text-secondary">
                                            ...
                                            <p class="mb-0">Hiện tại bạn chưa được phân công chuyến đi nào đang chạy hoặc chuẩn bị chạy.</p>
                                            <a href="trip" class="btn btn-outline-primary mt-3">
